...
/*
    ...
    {										// CHANGED FOR HIRES
        V_DrawPatch(x, viewwindowy - 4,						// CHANGED FOR HIRES
                    W_CacheLumpName(DEH_String("bordt"), PU_CACHE));		// CHANGED FOR HIRES
        V_DrawPatch(x, viewwindowy + viewheight,				// CHANGED FOR HIRES
                    W_CacheLumpName(DEH_String("bordb"), PU_CACHE));		// CHANGED FOR HIRES
    }										// CHANGED FOR HIRES
    for (y = viewwindowy; y < viewwindowy + viewheight; y += 16)		// CHANGED FOR HIRES
    {										// CHANGED FOR HIRES
        V_DrawPatch(viewwindowx - 4, y,						// CHANGED FOR HIRES
                    W_CacheLumpName(DEH_String("bordl"), PU_CACHE));		// CHANGED FOR HIRES
        V_DrawPatch(viewwindowx + viewwidth, y,					// CHANGED FOR HIRES
                    W_CacheLumpName(DEH_String("bordr"), PU_CACHE));		// CHANGED FOR HIRES
    }										// CHANGED FOR HIRES
    V_DrawPatch(viewwindowx - 4, viewwindowy - 4,				// CHANGED FOR HIRES
                W_CacheLumpName(DEH_String("bordtl"), PU_CACHE));		// CHANGED FOR HIRES
    V_DrawPatch(viewwindowx + viewwidth, viewwindowy - 4,			// CHANGED FOR HIRES
                W_CacheLumpName(DEH_String("bordtr"), PU_CACHE));		// CHANGED FOR HIRES
    V_DrawPatch(viewwindowx + viewwidth, viewwindowy + viewheight,		// CHANGED FOR HIRES
                W_CacheLumpName(DEH_String("bordbr"), PU_CACHE));		// CHANGED FOR HIRES
    V_DrawPatch(viewwindowx - 4, viewwindowy + viewheight,			// CHANGED FOR HIRES
                W_CacheLumpName(DEH_String("bordbl"), PU_CACHE));		// CHANGED FOR HIRES
*/
    ...
    {													// CHANGED FOR HIRES
        V_DrawPatch(x, (viewwindowy >> hires) - 4,							// CHANGED FOR HIRES
                    W_CacheLumpName(DEH_String("bordt"), PU_CACHE));					// CHANGED FOR HIRES
        V_DrawPatch(x, (viewwindowy >> hires) + (viewheight >> hires),					// CHANGED FOR HIRES
                    W_CacheLumpName(DEH_String("bordb"), PU_CACHE));					// CHANGED FOR HIRES
    }													// CHANGED FOR HIRES
    for (y = (viewwindowy >> hires); y < ((viewwindowy >> hires) + (viewheight >> hires)); y += 16)	// CHANGED FOR HIRES
    {													// CHANGED FOR HIRES
        V_DrawPatch((viewwindowx >> hires) - 4, y,							// CHANGED FOR HIRES
                    W_CacheLumpName(DEH_String("bordl"), PU_CACHE));					// CHANGED FOR HIRES
        V_DrawPatch((viewwindowx >> hires) + (viewwidth >> hires), y,					// CHANGED FOR HIRES
                    W_CacheLumpName(DEH_String("bordr"), PU_CACHE));					// CHANGED FOR HIRES
    }													// CHANGED FOR HIRES
...
/*
    if (viewwindowy < 25)							// CHANGED FOR HIRES
    {										// CHANGED FOR HIRES
        for (x = viewwindowx; x < viewwindowx + viewwidth; x += 16)		// CHANGED FOR HIRES
        {									// CHANGED FOR HIRES
            V_DrawPatch(x, viewwindowy - 4,					// CHANGED FOR HIRES
        ...
        V_DrawPatch(viewwindowx - 4, viewwindowy,				// CHANGED FOR HIRES
                    W_CacheLumpName(DEH_String("bordl"), PU_CACHE));		// CHANGED FOR HIRES
...
*/
    if ((viewwindowy >> hires) < 25)						// CHANGED FOR HIRES
    {										// CHANGED FOR HIRES
        for (x = (viewwindowx >> hires); x < ((viewwindowx >> hires) + (viewwidth >> hires)); x += 16)	// CHANGED FOR HIRES
        {									// CHANGED FOR HIRES
            V_DrawPatch(x, (viewwindowy >> hires) - 4,				// CHANGED FOR HIRES
