...
//
    for (i = 0; i < LIGHTLEVELS; i++)
    {
        ...
        {
/*
            scale =							// CHANGED FOR HIRES
                FixedDiv((SCREENWIDTH / 2 * FRACUNIT),			// CHANGED FOR HIRES
                         (j + 1) << LIGHTZSHIFT);			// CHANGED FOR HIRES
*/
            scale =							// CHANGED FOR HIRES
                FixedDiv((ORIGWIDTH / 2 * FRACUNIT),			// CHANGED FOR HIRES
                         (j + 1) << LIGHTZSHIFT);			// CHANGED FOR HIRES
...
void R_ExecuteSetViewSize(void)
{
    ...
    {
/*
        scaledviewwidth = setblocks * 32;			// CHANGED FOR HIRES
...
//
/*
    pspritescale = FRACUNIT * viewwidth / SCREENWIDTH;		// CHANGED FOR HIRES
    pspriteiscale = FRACUNIT * SCREENWIDTH / viewwidth;		// CHANGED FOR HIRES
*/
